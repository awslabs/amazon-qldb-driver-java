...
public interface QldbDriverBuilder {
     ...
     * </p>
     *
     * @param ledgerName The name of the ledger to create a driver with.
     ...
     * use {@link #httpClientBuilder(SdkAsyncHttpClient.Builder)}.</p>
     *
     * <p>
     * The clientBuilder is mandatory.
     * </p>
     *
     * @param clientBuilder The builder used to create the low-level session.
     * @return This builder object.
     */
     ...
     * </p>
     *
     * @param ionSystem The {@link IonSystem} to use.
     * @return This builder object.
     */
     ...
     * </p>
     *
     * @param retryPolicy Contains the rules to retry the transaction.
     * @return This builder object.
     */
     ...
     * </p>
     *
     * @param readAhead The number of read-ahead buffers for each open result set, 0 for no asynchronous read-ahead.
     * @return This builder object.
     */
     ...
     *
     * @param readAhead       The number of read-ahead buffers for each open result set, 0 for no asynchronous read-ahead.
     * @param executorService The executor to be used by the retrieval thread.
     * @return This builder object.
     */
     ...
     * </p>
     *
     * @param httpClientBuilder The builder used to create the http client.
     * @return This builder object.
     */
