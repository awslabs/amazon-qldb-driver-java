...
class StreamResult implements Result {
     ...
     * @param statementResult      The result of the statement execution.
     * @param txnId                The unique ID of the transaction.
     * @param readAheadBufferCount The number of buffers to asynchronously read ahead, 0 for synchronous retrieval.
     * @param ionSystem            The Ion System to use for this object.
