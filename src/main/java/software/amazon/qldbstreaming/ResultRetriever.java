...
class ResultRetriever {
     ...
     * @param firstPage       The first chunk of the result, returned by the initial execution.
     * @param txnId           The unique ID of the transaction.
     * @param readAhead       The number of buffers to asynchronously read ahead, 0 for synchronous retrieval.
     * @param executorService The executor service to use for asynchronous retrieval. Null if new threads should be created.
     * @param ioUsage         The initial IOUsage statistics from the statement execution.
     * @param timingInfo      The initial server side timing information from the statement execution.
     */
    ...
    private static class Retriever {
         ...
         *
         * @param session       The parent session to use in retrieving results.
         * @param txnId         The unique ID of the transaction.
         * @param nextPageToken The unique token identifying the next chunk of data to fetch for this result set.
         * @param ioUsage       The initial IOUsage from the statement execution.
         * @param timingInfo    The initial TimingInformation from the statement execution.
         */
        ...
        void updateMetrics(FetchPageResult fetchPageResult) {
            ...
            software.amazon.awssdk.services.qldbsessionv2.model.TimingInformation timingInfo =
    ...
    private static class ResultRetrieverRunnable extends Retriever implements Runnable {
         ...
         * @param txnId         The unique ID of the transaction.
         * @param nextPageToken The unique token identifying the next chunk of data to fetch for this result set.
         * @param readAhead     The maximum number of chunks of data to buffer at any one time.
         * @param isClosed      {@link AtomicBoolean} tracking the state of the parent {@link ResultRetriever}.
         * @param ioUsage       The initial IOUsage from the statement execution.
         * @param timingInfo    The initial TimingInformation from the statement execution.
         */
