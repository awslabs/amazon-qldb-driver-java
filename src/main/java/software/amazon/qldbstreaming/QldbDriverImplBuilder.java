...
class QldbDriverImplBuilder implements QldbDriverBuilder {
     ...
     *
     * @param maxConcurrentTransactions The maximum number of sessions that can be created from the pool at any one time.
    ...
    public QldbDriverBuilder readAhead(int readAhead) {
        software.amazon.qldbstreaming.Validate.assertIsAtLeastTwo(readAhead, "readAhead");
